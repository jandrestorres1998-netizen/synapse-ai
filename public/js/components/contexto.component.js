...
export class ContextoComponent {
  ...
  static async render() {
    ...
    try {
      ...
      setText('context-size', `${activeChars} caracteres en cada petición`);
      ...
      list.innerHTML = memories.map(m => `
        <div class="row">
          ...
          <div class="row-actions">
            ...
            <button class="btn btn-quiet" data-delete="${esc(m.id)}" style="color: var(--critical);">Eliminar</button>
          </div>
        </div>`).join('');
